...
import background from '../../../Assets/images/origem.jpg'
    ...
    return (
       <> 
        <Div style={{ backgroundImage: 'url(' + background + ')', backgroundSize: 'cover' }}>
            <DivInside>
                <H3>Hulk</H3>
                <P>Na história Original dos quadrinhos, o Hulk
                    é um selvagem e poderoso alter ego do Dr.
                    Robert Bruce Banner, um cientista que foi 
                    atingido por raios gama enquanto salvava um
                    adolescente durante o teste militar.
                </P>
